...
const FORECAST_BASE_URL = `https://api.openweathermap.org/data/2.5/forecast?appid=${API_KEY}&`;
const FIND_BASE_URL = `https://api.openweathermap.org/data/2.5/find?appid=${API_KEY}&`;
